...
> **Degradation in this skill:** Look the facts up yourself with direct tool use in this session instead of dispatching an exploration sub-agent. Do not block the frontier on it: ask the non-dependent questions first, then fold in what you found.

...
import { TelegramGroupNotFoundError, BotNotConnectedError, Actor, ClientInfo } from './telegram-groups-service.js';

export interface GroupTestingOptions {

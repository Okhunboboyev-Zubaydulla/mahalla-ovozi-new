...
describe('DistrictActivationModal Isolated Component Tests (AC 1, 7, 16)', () => {
    ...
    function renderModal(props) {
        return render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(ConfigProvider, { theme: mahallaTheme, children: _jsx(DistrictProvider, { children: _jsx(BrowserRouter, { children: _jsx(DistrictActivationModal, { ...props }) }) }) }) }));
    }
    ...
    it('renders inline error alert with dynamic blocker action links on 409 DISTRICT_NOT_READY failure (AC 16)', async () => {
        const errorWithBlockers = new ApiError('Туманни фаоллаштириш учун барча талаблар бажарилмаган.', 'DISTRICT_NOT_READY', 409, false, [
            {
                key: 'hokim_account',

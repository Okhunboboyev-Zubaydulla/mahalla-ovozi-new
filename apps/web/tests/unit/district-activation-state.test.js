...
describe('District Activation & First Login Password State Integration (Phase 5)', () => {
    ...
    const queryWrapper = ({ children }) => (_jsx(QueryClientProvider, { client: queryClient, children: children }));
    const authWrapper = ({ children }) => (_jsx(QueryClientProvider, { client: queryClient, children: _jsx(AuthProvider, { children: children }) }));
    it('ApiError preserves blockers array when provided (Task 6.1)', () => {
        ...
        const error = new ApiError('Туманни фаоллаштириш учун барча талаблар бажарилмаган.', 'DISTRICT_NOT_READY', 409, false, blockers);
    ...
    describe('useDistrictActivation Hook (Task 6.5)', () => {
        ...
        it('gracefully handles DISTRICT_ALREADY_ACTIVE error and refreshes cache', async () => {
            const alreadyActiveError = new ApiError('Туман аллақачон фаоллаштирилган.', 'DISTRICT_ALREADY_ACTIVE', 409, false);
        ...
        it('propagates unmet prerequisites error with blockers', async () => {
            ...
            const notReadyError = new ApiError('Туманни фаоллаштириш учун барча талаблар бажарилмаган.', 'DISTRICT_NOT_READY', 409, false, blockers);

...
function renderTable(groups = mockGroups) {
    ...
    return render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(ConfigProvider, { theme: mahallaTheme, children: _jsx(TelegramGroupTable, { districtId: "dist_test_1" }) }) }));
}

...
function renderConsoleLayout() {
    ...
    return render(_jsx(QueryClientProvider, { client: queryClient, children: _jsx(ConfigProvider, { theme: mahallaTheme, children: _jsx(AuthProvider, { children: _jsx(DistrictProvider, { children: _jsx(BrowserRouter, { children: _jsx(ConsoleLayout, {}) }) }) }) }) }));
}

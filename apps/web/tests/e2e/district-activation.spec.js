...
test.describe('Story 1.7: Validate and Activate a District & Hokim First Sign-In E2E Journeys', () => {
    test('executes complete district activation journey, prerequisite gating, and Hokim first sign-in password replacement (AC 1-18)', async ({ page, }) => {
